      ...
      <div className="w-2/4 md:w-1/4">
        ...
        <Section delay="0.4">
          ...
          <Box alignItems="center" my={2}>
            <Paragraph>
              En lagom gammal hallänning som under studieperioden fått upp ett
              intresse för programmering. Utöver intresset för programmering och
              teknologi så består vardagen mycket utav träning, kost och aktier.
            </Paragraph>
          </Box>
