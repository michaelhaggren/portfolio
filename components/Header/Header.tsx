            ...
            {links.map((path, index) => (
              <NextLink href={path.route} key={index} passHref>
                <motion.button
                  ...
                  className="text-left text-sm  mb:w-auto w-14 hover:border-b hover:border-current ml-6 mt-6 mb-4 md:mr-6 md:mb-0 md:mt-2 md:mx-6 font-montserrat font-bold"
                >
                  {path.title}
                </motion.button>
              </NextLink>
